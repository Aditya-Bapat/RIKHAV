...
if df.empty:
    ...
    for i in range(1, len(df)):
        ...
        previous_investment = df['Investment'].iloc[i - 1] if i > 0 else 0
        ...
        if current_signal == 'Buy':
            ...
            if short_sell_signal is not None:
                ...
                if not investments_in_span.empty:
                    ...
                    min_investment = filtered_investments[0] if not filtered_investments.empty else investments_in_span.min()
